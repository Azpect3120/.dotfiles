...
-- Use font-manager with awesome fonts to 
-- apply cool icons!
...
awful.screen.connect_for_each_screen(function(s)
  ...
  awful.tag(tab_names, s, tab_layouts) ]]
  ...
  -- DISABLED: Default status bar (wibox)
  -- Create the wibox
...
globalkeys = gears.table.join(
  ...
  -- Prompt: Run rofi run
  awful.key({modkey}, "r", function() awful.util.spawn("rofi -show combi") end, {description = "run rofi prompt", group = "launcher"}),

  -- Firefox
  awful.key({modkey}, "b", function() awful.util.spawn("firefox") end, {description = "launch firefox", group = "applications"}),
...
awful.rules.rules = {
  ...
  -- DISABLED: Add titlebars to normal clients and dialogs
